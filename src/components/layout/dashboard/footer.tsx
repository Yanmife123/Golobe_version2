  ...
  return (
    <form className="flex gap-4 md:justify-start justify-center">
      <input
        ...
        required
      />
      <button className="bg-primaryT text-white py-2 px-4 rounded-[5px] font-sans text-sm font-semibold">
        Subscribe
      </button>
    </form>
  );
  ...
  return (
    <footer className="mt-12 relative h-auto pt-16 shadow-card">
      <div className="h-[340px] absolute top-0 left-0 w-full flex justify-center z-2">
        <div className="lg:w-[80%] w-[95%] h-full brightness-100 shadow-card rounded-[20px] z-2 px-6">
          <div className="w-full flex justify-between h-full">
            <div className="flex-1  text-primaryT flex flex-col gap-4 md:items-start items-center justify-center ">
      ...
      <div className=" pt-[220px] mt-[100px] bg-secondaryT pb-15 px-8 flex justify-center z-1 items-end">
